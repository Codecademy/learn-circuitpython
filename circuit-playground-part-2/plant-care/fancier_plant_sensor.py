...
You can change the step size of the capacity leds below, as in at what threshold the led triggers, some trial and error is needed to find best values
...
while True:
    ...
    if cpx.button_b:
        ...
        if cpx.switch:
            #print(touch.raw_value, touch_init) # used for debug
